...
export function Criadero({ language, province, user, gameState }: CriaderoProps) {
  return (
    <div className="space-y-6">
      <div className="flex items-center gap-3">
        <Egg className="h-8 w-8 text-[#d4af37]" />
        <div>
          <h2 className="text-2xl font-bold text-[#d4af37]">
            {language === "es" ? "Criadero" : "Breeding Grounds"}
          </h2>
          <p className="text-sm text-gray-400">
            {language === "es" ? "Criaturas míticas y bestias de guerra" : "Mythical creatures and war beasts"}
          </p>
        </div>
      </div>
